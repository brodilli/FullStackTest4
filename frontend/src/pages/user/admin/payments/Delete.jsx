...
export function PaymentMethodDelete() {
  ...
  const adminPaymentMethodDetails = useSelector((state) => state.adminPaymentMethodDetails);
  const {
    loading: loadingDetails,
    error: errorDetails,
    paymentMethodDetails,
  } = adminPaymentMethodDetails;
  const adminPaymentMethodDelete = useSelector((state) => state.adminPaymentMethodDelete);
  const {
    loading: loadingDelete,
    error: errorDelete,
    message,
  } = adminPaymentMethodDelete;
        ...
        {loading || loadingDetails ? (
          ...
          <div className="relative max-h-[90%]  w-11/12 overflow-hidden rounded-md bg-white shadow lg:w-1/2 2xl:w-2/6">
            <div className="flex w-full items-center justify-between rounded-t-md bg-blue-gray-800 p-2 px-4 text-white">
              <h2 className="text-2xl  text-white">Eliminar PaymentMethodo</h2>
              <button
                type="button"
            ...
            >
              <div className="flex flex-col justify-center gap-3">
                ...
                <div className="my-3 flex justify-center">
                  ¿Seguro que deseas eliminar este Metodo de Pago?
                </div>
                ...
                <div className="flex w-full justify-center px-6 text-2xl">
                  ...
                  <div className="mx-3 flex w-1/2 justify-center">
                    <input
                      ...
                      defaultValue={paymentMethodDetails?.name}
                      disabled
                    />
                  </div>
                </div>
